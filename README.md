...
Open to worldwide remote contract, freelance, and entry-level opportunities in software engineering, Python development, API testing, QA automation, and technical AI evaluation.

**Core stack:** Python · Java · JavaScript · C/C++ · SQL · HTML/CSS · Git · REST APIs · SQLite · Testing
...
- LinkedIn: [haoran-tan-dev](https://www.linkedin.com/in/haoran-tan-dev/)
- GitHub: [T98765SREDT](https://github.com/T98765SREDT)
